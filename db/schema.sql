...
CREATE TABLE IF NOT EXISTS transactions (
  ...
  account_number VARCHAR(5) NOT NULL REFERENCES accounts(account_number) ON DELETE CASCADE, -- source account
  target_account VARCHAR(5) REFERENCES accounts(account_number) ON DELETE RESTRICT,
